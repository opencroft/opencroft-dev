...
/**
 * A ReactFlow node that renders a floating comment bubble.
 * Positioned above its target node — sticks to it during pan/zoom.
 */
export const CommentNode = memo(function CommentNode({
  data,
}: NodeProps) {
  const { nodeId, message, onDismiss } = data as CommentNodeData;
