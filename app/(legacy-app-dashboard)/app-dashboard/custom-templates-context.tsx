...
import { loadTemplates, saveTemplates } from '@/app/(legacy-app-dashboard)/nodes/custom/actions';
import { compileTemplate } from '@/app/(legacy-app-dashboard)/nodes/custom/compiler';
...
export function CustomTemplatesProvider({ children }: { children: React.ReactNode }) {
  ...
  const upsertTemplate = useCallback(async (template: CustomTemplate) => {
