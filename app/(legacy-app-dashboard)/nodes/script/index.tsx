...
import { ButtonPin, HANDLE_EXECUTION } from '@/app/(legacy-app-dashboard)/nodes/shared/button-pin';
...
function ScriptComponent({ id, data, selected }: NodeProps<ScriptNode>) {
  ...
  return (
    <PinnedNode
      ...
      input={
        <ButtonPin handleId={HANDLE_EXECUTION} icon={TerminalSquare} label="Exec" side="left" />
      }
      output={
