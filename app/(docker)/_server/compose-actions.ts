...
export const getDockerComposes = createServerFn({ method: 'POST' })
  .inputValidator((context: string) => context)
  .handler(async ({ data: context }): Promise<DockerCompose[]> => {
...
export const createDockerCompose = createServerFn({ method: 'POST' })
  .inputValidator((data: { context: string; name: string }) => data)
...
export const updateDockerCompose = createServerFn({ method: 'POST' })
  .inputValidator((data: { context: string; name: string; content: string }) => data)
  .handler(async ({ data }): Promise<void> => {
...
export const deleteDockerCompose = createServerFn({ method: 'POST' })
  .inputValidator((data: { context: string; name: string }) => data)
  .handler(async ({ data }): Promise<void> => {
    const { context, name } = data
...
export const renameDockerCompose = createServerFn({ method: 'POST' })
  .inputValidator((data: { context: string; oldName: string; newName: string }) => data)
  .handler(async ({ data }): Promise<void> => {
...
function convertContainerDataToServiceFormat(serviceData: CreateDockerContainerData, serviceName: string): Record<string, unknown> {
  ...
  if (serviceData.environmentVariables && serviceData.environmentVariables.length > 0) {
    service.environment = serviceData.environmentVariables.reduce(
      (env, v) => {
        env[v.key] = v.value
        return env
      },
  ...
  if (serviceData.build) {
    ...
    if (serviceData.build.args && serviceData.build.args.length > 0) {
      build.args = serviceData.build.args.reduce(
        (acc, v) => {
          acc[v.key] = v.value
          return acc
        },
...
export const removeServiceFromCompose = createServerFn({ method: 'POST' })
  .inputValidator((data: { context: string; composeName: string; serviceName: string }) => data)
  .handler(async ({ data }): Promise<void> => {
...
export const upCompose = createServerFn({ method: 'POST' })
  .inputValidator((data: { context: string; name: string }) => data)
  .handler(async ({ data }): Promise<void> => {
    const { context, name } = data
...
export const deployCompose = createServerFn({ method: 'POST' })
  .inputValidator((data: { context: string; name: string }) => data)
  .handler(async ({ data }): Promise<void> => {
    const { context, name } = data
...
export const stopCompose = createServerFn({ method: 'POST' })
  .inputValidator((data: { context: string; name: string }) => data)
  .handler(async ({ data }): Promise<void> => {
    const { context, name } = data
...
export const downCompose = createServerFn({ method: 'POST' })
  .inputValidator((data: { context: string; name: string }) => data)
  .handler(async ({ data }): Promise<void> => {
    const { context, name } = data
...
export const terminateService = createServerFn({ method: 'POST' })
  .inputValidator((data: { context: string; composeName: string; serviceName: string }) => data)
  .handler(async ({ data }): Promise<void> => {
    const { context, composeName, serviceName } = data
...
export const rebootService = createServerFn({ method: 'POST' })
  .inputValidator((data: { context: string; composeName: string; serviceName: string }) => data)
  .handler(async ({ data }): Promise<void> => {
    const { context, composeName, serviceName } = data
...
export const deployService = createServerFn({ method: 'POST' })
  .inputValidator((data: { context: string; composeName: string; serviceName: string }) => data)
  .handler(async ({ data }): Promise<void> => {
    const { context, composeName, serviceName } = data
