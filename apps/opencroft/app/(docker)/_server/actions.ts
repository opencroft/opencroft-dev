...
export const getDockerContainers = createServerFn({ method: 'POST' })
  .inputValidator((server?: string) => server)
  .handler(async ({ data: server }): Promise<DockerContainer[]> => {
...
export const createContainer = createServerFn({ method: 'POST' })
  .inputValidator((containerData: CreateDockerContainerData) => containerData)
  .handler(async ({ data: containerData }): Promise<void> => {
    return new Promise((resolve, reject) => {
...
export const startContainer = createServerFn({ method: 'POST' })
  .inputValidator((containerId: string) => containerId)
  .handler(async ({ data: containerId }): Promise<void> => {
    return new Promise((resolve, reject) => {
...
export const stopContainer = createServerFn({ method: 'POST' })
  .inputValidator((containerId: string) => containerId)
  .handler(async ({ data: containerId }): Promise<void> => {
    return new Promise((resolve, reject) => {
...
export const rebootContainer = createServerFn({ method: 'POST' })
  .inputValidator((containerId: string) => containerId)
  .handler(async ({ data: containerId }): Promise<void> => {
    return new Promise((resolve, reject) => {
...
export const removeContainer = createServerFn({ method: 'POST' })
  .inputValidator((containerId: string) => containerId)
  .handler(async ({ data: containerId }): Promise<void> => {
    return new Promise((resolve, reject) => {
...
export const getContainerMounts = createServerFn({ method: 'POST' })
  .inputValidator((containerId: string) => containerId)
...
export const openTerminalInContainer = createServerFn({ method: 'POST' })
  .inputValidator((data: { containerId: string; workingDir?: string }) => data)
