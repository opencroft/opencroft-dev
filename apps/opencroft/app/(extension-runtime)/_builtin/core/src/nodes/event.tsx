import { dispatch, icons, NodeFrame, OutputHandle, React, toast, useReactFlow } from '@ext/host'
import { Button, Input, Label, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@ext/ui'
      ...
      <div className='flex items-center gap-1'>
        <Input
          ...
          onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
            updateData({ intervalValue: Math.max(1, parseInt(e.target.value, 10) || 1) })
          }
